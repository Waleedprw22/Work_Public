...
class PyBulletSim:
    ...
    def move_joints(self, target_joint_state, speed=0.03):#changed from .03 to 1
        """
    ...
    def move_tool(self, position, orientation, speed=0.03):
        ...
        joints = p.calculateInverseKinematics(self.robot_body_id, self.robot_end_effector_link_index, position, orientation, maxNumIterations = 50 )
        target_joint_state =joints
    ...
    def get_grasp_position_angle(self, object_id):
        ...
        position, grasp_angle = p.getBasePositionAndOrientation(object_id) #convery quartinion to euler first
        orientation = p.getEulerFromQuaternion(grasp_angle)
        
        grasp_angle = orientation[2] #return last part
        # ==================================
